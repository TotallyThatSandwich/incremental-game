...
impl Default for GameState {
    fn default() -> Self {
        ...
        let buyables = vec![
            ...
            Buyable::new(1, "Click Production Mulitplier: clickers produce 1.25x as much gold", 001, 100.0, 2.0, 0.0, CostType::Gold, UpgradeType::GoldMultiplier),
                ...
                CostType::Gold => {
                    if &self.gold >= &selected_upgrade.cost {
                        ...
                        match &selected_upgrade.buyable_type {
                            ...
                            UpgradeType::GoldMultiplier => self.gpc *= 1.25,
